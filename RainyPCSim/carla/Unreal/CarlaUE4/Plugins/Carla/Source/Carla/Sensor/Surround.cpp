...
FLidarDescription create_Surround(const std::string& lidar_name)
{
	...
	else if (lidar_name == "waymo_top_no_drop")
	{
		return create_waymo_top_no_drop();
	}
...
FLidarDescription create_pandar_40p()
{
	...
	pandar_40p.PointsPerSecond = 720000;
	pandar_40p.vfov = {
			15,    11,    8,     5,     3,     2,     1.67,  1.33,  1,     0.67,
			0.33,  0,     -0.33, -0.67, -1,    -1.33, -1.67, -2.00, -2.33, -2.67,
			-3.00, -3.33, -3.67, -4.00, -4.33, -4.67, -5.00, -5.33, -5.67, -6.00,
			-7,    -8,    -9,    -10,   -11,   -12,   -13,   -14,   -19,   -25 };
	pandar_40p.NoiseStdDev = 0.0001;
	pandar_40p.DropOffGenRate = 0.02;
	pandar_40p.DropOffIntensityLimit = 0.5;
	pandar_40p.DropOffAtZeroIntensity = 0.08;
	return pandar_40p;
}
...
FLidarDescription create_waymo_top_no_drop()
{
	FLidarDescription waymo_top;
	waymo_top.LidarType = "Surround";
	waymo_top.NAME = "waymo_top_no_drop";
	waymo_top.Channels = 64;
	waymo_top.Range = 75; // m
	waymo_top.HorizontalFov = 360.0f;
	waymo_top.RotationFrequency = 10.0f;
	...
	waymo_top.NoiseStdDev = 0.025;
	waymo_top.DropOffAtZeroIntensity = 0;
	waymo_top.DropOffIntensityLimit = 0;
	waymo_top.DropOffGenRate = 0;
	return waymo_top;
}
...
FLidarDescription create_pandar128()
{
	...
	//pandar128
	//pandar128.NAME=3;
	pandar128.LidarType = "mechanical";
...
FLidarDescription create_rs_m1()
{
	FLidarDescription rs_m1;
	 ...
	 //rs_m1.NAME=6;
	 rs_m1.LidarType = "mechanical";
	 rs_m1.NAME = "rs_m1";
	 rs_m1.Channels=164;
	 rs_m1.Range=120;
	 rs_m1.HorizontalFov=120.0f;
	 rs_m1.RotationFrequency=10.0f;
	 rs_m1.PointsPerSecond=750000;
	 for (int i = 0; i < 52; i++) {
	     rs_m1.vfov.push_back(12.5 - 0.2 * i);
	 }
	 for (int i = 0; i < 32; i++) {
	     rs_m1.vfov.push_back(-12.5 + 0.2 * i);
	 }
	 for (int i = 0; i < 80; i++) {
	     rs_m1.vfov.push_back(-6.0 + 0.1 * i);
	 }
...
FLidarDescription create_pandar_qt()
{
	...
	//pandar_qt
	//pandar_qt.NAME=7;
	pandar_qt.LidarType = "mechanical";
...
FLidarDescription create_pandar_40m()
{
	...
	//pandar_40m
	//pandar_40m.NAME = 9;
	pandar_40m.LidarType = "mechanical";
...
FLidarDescription create_pandar_40p()
{
	...
	//pandar_40p
	//pandar_40p.NAME = 10;
	pandar_40p.LidarType = "mechanical";
...
FLidarDescription create_pandar_xt()
{
	...
	//     ##XT  
    //pandar_xt.NAME=11;
	pandar_xt.LidarType = "mechanical";
...
FLidarDescription create_os1_64_gen2()
{
	...
	os1_64_gen2.LidarType = "mechanical";

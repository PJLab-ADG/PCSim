    ...
    FActorDefinition &Definition)
{
  ...
  //lidar_name //加入name变量zwq用string代替原来的int值
    ...
    FLidarDescription &Lidar)
{
  ...
  Lidar.LidarType=
	  RetrieveActorAttributeToString("lidar_type", Description.Variations, Lidar.LidarType); //zwq
  Lidar.NAME=
      /*RetrieveActorAttributeToInt("name", Description.Variations, Lidar.NAME);*/
	  RetrieveActorAttributeToString("name", Description.Variations, Lidar.NAME); //zwq改为toString
  Lidar.EnableGhost=
	  RetrieveActorAttributeToBool("enable_ghost", Description.Variations, Lidar.EnableGhost); //zwq
  Lidar.Channels =

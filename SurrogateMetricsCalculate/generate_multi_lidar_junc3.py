...
def main():
    ...
    try:
        ...
        lidar_location1 = carla.Location(x=-260, y=-10, z=3.5) # 1
        lidar_location2 = carla.Location(x=-260,  y=12, z=3.5) # 2
        lidar_location3 = carla.Location(x=-278, y=1, z=3.5) # 3
        # lidar_location4 = carla.Location(x=-200.0, y=-11.0, z=3.5) # 4
        lidar_rotation1 = carla.Rotation(15, -45, 0) # (pitch=0, yaw=-90, roll=0)
        lidar_rotation2 = carla.Rotation(15, 45, 0) # (pitch=0 yaw=-90, roll=0)
        lidar_rotation3 = carla.Rotation(-15, 0, 0) # (pitch=0, yaw=-90, roll=0)
